...
On the right is the console which we can write any code in. But when we close R this will all be gone. Snything we want to save to run or see again we should write it in a script. To run code, press Ctrl + Enter on current line, or Ctrl + shift + Enter to run entire script.
Save it when done.
